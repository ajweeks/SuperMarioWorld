...
public:
	enum class SOUND
	{
		...
		FIRE_BALL_THROW, CHARGIN_CHUCK_HEAD_BONK,
		KOOPA_DEATH, ENEMY_HEAD_STOMP_START, ENEMY_HEAD_STOMP_END, MIDWAY_GATE_PASSTHROUGH, BEANSTALK_SPAWN, 
		COURSE_CLEAR_FANFARE, DRUMROLL, OUTRO_CIRCLE_TRANSITION,
